    ...
    try {
      ...
      if (!token) {
        toast({
          ...
          description: "Silakan login terlebih dahulu sebelum menambahkan produk",
          variant: "destructive",
        })
      ...
      // Validate form data
      if (!formData.namaProduk || !formData.deskripsi || !formData.harga || !formData.stok || !image) {
        toast({
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="stok" name="stok" type="number" value={formData.stok} onChange={handleChange} required />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="gambar">Gambar Produk</Label>
                <Input id="gambar" type="file" accept="image/*" onChange={handleImageChange} required />
              </div>

              <div className="flex flex-col gap-4 pt-2">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="isForSale">Tersedia untuk Dijual</Label>
                    <p className="text-sm text-gray-500">Produk ini dapat dibeli oleh pelanggan</p>
                  </div>
                  <Switch
                    id="isForSale"
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="isForRent">Tersedia untuk Disewa</Label>
                    <p className="text-sm text-gray-500">Produk ini dapat disewa oleh pelanggan</p>
                  </div>
                  <Switch
                    id="isForRent"
                    checked={formData.isForRent}
                    onCheckedChange={(checked) => handleSwitchChange("isForRent", checked)}
                  />
                </div>
              </div>
            </div>
