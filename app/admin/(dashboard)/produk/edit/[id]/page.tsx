...
const formSchema = z.object({
  namaProduk: z.string().min(3, { message: "Nama produk harus minimal 3 karakter" }),
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Edit informasi produk yang akan ditampilkan di website</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Masukkan deskripsi produk" className="min-h-[150px]" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="Tenda Camping">Tenda Camping</SelectItem>
                        <SelectItem value="Aksesori">Aksesori</SelectItem>                        
                        <SelectItem value="Sleeping Bag">Sleeping Bag</SelectItem>
                        <SelectItem value="Perlengkapan Outdoor & Survival">Perlengkapan Outdoor & Survival</SelectItem>
                        <SelectItem value="Lampu">Lampu</SelectItem>
                        <SelectItem value="Carrier & Ransel">Carrier & Ransel</SelectItem>
                        <SelectItem value="Peralatan Memasak Outdoor">Peralatan Memasak Outdoor</SelectItem>                       
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>Produk tersedia untuk dijual</FormDescription>
                      </div>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel>Disewakan</FormLabel>
                        <FormDescription>Produk tersedia untuk disewa</FormDescription>
                      </div>
                    </FormItem>
                  )}
                />
