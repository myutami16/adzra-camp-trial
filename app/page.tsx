      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/produk" className="text-primary-dark hover:underline font-medium">
              Lihat Semua
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Pengalaman pelanggan kami yang telah menggunakan layanan Adzra Camp.
            </p>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-200">
                    "Peralatan yang disewakan sangat terawat dan berkualitas. Proses sewa juga sangat mudah dan cepat.
            ...
            <Card className="bg-white/10 border-none">
              <CardContent className="p-6">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-200">
                    "Saya sangat puas dengan pelayanan Adzra Camp. Peralatan yang disewakan sangat lengkap dan harganya
                    terjangkau."
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="bg-white/10 border-none">
              <CardContent className="p-6">
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-200">
                    "Produk yang dijual sangat berkualitas. Saya sudah membeli beberapa item dan semuanya awet dan
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/blog" className="text-primary-dark hover:underline font-medium">
              Lihat Semua
            </Link>
          </div>
      ...
      <section className="py-16 bg-accent">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white text-lg mb-8 max-w-2xl mx-auto">
            Dapatkan peralatan camping terbaik untuk petualangan outdoor Anda bersama Adzra Camp.
          </p>
