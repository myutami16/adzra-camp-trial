    ...
    <footer className="bg-primary-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block">
              <Image src="/images/logo.png" alt="Adzra Camp Logo" width={120} height={120} className="h-24 w-auto" />
            </Link>
            <p className="text-gray-300">
              Penyedia peralatan camping berkualitas untuk sewa dan jual di Mojokerto, Jawa Timur.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Adzra Camp. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
